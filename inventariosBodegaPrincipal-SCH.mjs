...
// FUNCION PARA CAPTURAR ERROR Y REINTENTAR EN CASO DE NO ENCONTRAR SELECTOR
  ...
  const ingresarParametrosReporteInventario = async () => { // ............Todavia aluna ve falla
    ...
    await page.waitForTimeout(2000)
    console.log('Inv. Final Valorizado - Costo de Reposicion - Seleccionado')
...
// EJECUCION DEL PROGRAMA
  ...
  (async () => {
    console.log('Proceso Descarga Reportes Inventario Bodega Principal Supply Chain Inicializado')
